...
Введите сдвиг (целое число) в поле "Введите сдвиг".
Нажмите "Шифровать", чтобы зашифровать текст, или "Дешифровать", чтобы вернуть его в исходное состояние.
Результат будет отображён в нижнем поле "Результат".
"""